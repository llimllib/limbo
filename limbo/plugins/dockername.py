# -*- coding: utf-8 -*-
"""!dockername Random docker name"""

from random import choice
import re 

# source: https://github.com/docker/docker-ce/blob/master/components/engine/pkg/namesgenerator/names-generator.go
docker_names = {
	"left" : [
		"admiring",
		"adoring",
...
def docker_name():
    return choice(docker_names["left"])+"_"+choice(docker_names["right"])
...
def on_message(msg, server):
    ...
    """
    text = msg.get("text", "")
    match = re.findall(r"!dockername", text)
    if not match:
        return
